...
// accepts an objecct
// returns an array traverse the array check each key and value, if key.length is
// equalto 5, push key to array, if value.length=5
// if value.length===5 'earth'.length===5 ['earth']
// accepts an objecct
// returns an array traverse the array check each key and value, if key.length is
// equalto 5, push key to array, if value.length=5
// if value.length===5 'earth'.length===5 ['earth']
